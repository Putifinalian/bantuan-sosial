<div class="table-responsive">
    <table class="table-matrik-keputusan table table-hover table-bordered">
        <thead>
            <tr>
                <th rowspan="4" class="align-middle text-center table-dark">No</th>
                <th rowspan="4" class="align-middle text-center table-dark">ID Calon Penerima</th>
                <?php foreach ($id_kriteria_ as $key => $id_kriteria) : ?>
                    <th colspan="1" rowspan="1" class="align-middle text-center table-dark" data-id_kriteria="<?= $id_kriteria->id_kriteria ?>" data-tipe="<?= $id_kriteria->tipe_kriteria ?>" data-bobot="<?= $id_kriteria->nilai_bobot ?>">
