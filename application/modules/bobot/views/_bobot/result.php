<div class="modal fade" id="modal-bobot-result" tabindex="-1" aria-labelledby="modal-bobot-result-label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-bobot-result-label">Kalkulasi AHP</h5>
            ...
            <div class="modal-body">
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="pills-2" role="tabpanel" aria-labelledby="pills-2-tab">
                        <p class="mb-0 m-t-30">Profile Content</p>
                    </div>
                    <div class="tab-pane fade" id="pills-3" role="tabpanel" aria-labelledby="pills-3-tab">
                        <p class="mb-0 m-t-30">Contact Content</p>
                    </div>
                    <div class="tab-pane fade" id="pills-4" role="tabpanel" aria-labelledby="pills-4-tab">
                        <p class="mb-0 m-t-30"> Check Consistency</p>
                    </div>
                </div>
